					...
					<ul class="nav-menu">
						...
						<li class="menu-has-children">Account
							<ul>
								...
								<li>
									<a href="register.php">
										<i class="lnr lnr-user"></i> Register</a>
								</li>
							</ul>
						</li>
					</ul>
...
>>>>>>> f82c752e92106a510ae9496a3164815b6424113e:public/about.php
		...
		<div class="container">
			<div class="row align-items-center justify-content-start">
				<div class="col-lg-6 no-padding home-about-right">
					...
					<p>
						This is a platform that connects all PSPs(product and service providers) in all divisions within a location for proper scale
						of avaliability, visibility and accessibility of PSs(product and services).
					</p>
					<div class="row no-gutters">
						...
						<div class="single-services col">
							...
							<p>
								<b>L</b>ss
								<b>H</b>ub is always liable to all product listed on quick sales. So feel free to
								<a href="#">reach us</a> if what you saw was not what you got.
							</p>
						</div>
					</div>
				</div>
	...
	<!-- start write-up on about us -->
	<section>
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="text sample-text-area">
						<p>
							<span style="font-size: 20pt; line-height: 107%; font-family: 'Arial',sans-serif; color: black;">
								What is
								<strong style="color: #175176;">L</strong>uss<strong style="color: #9ca1a4;">H</strong>ub?
							</span>
						</p>
						<p>
							<span>
								<span>
									<strong style="color: #175176;">L</strong>uss<strong style="color: #9ca1a4;">H</strong>ub&nbsp;
								</span>provides a platform where product and services providers will have a chain of market that makes their products/services
								visible and accessibly not only to the internet users but also to leaders in that market making availability of stock
								an achievable goal.</span>
						</p>
						<p>
							<span style="font-size: 20pt; line-height: 107%; font-family: 'Arial',sans-serif; color: black;">
								What makes
								<strong style="color: #175176;">L</strong>uss<strong style="color: #9ca1a4;">H</strong>ub unique
							</span>
						</p>
						<p>
								<strong style="color: #175176;">L</strong>uss<strong style="color: #9ca1a4;">H</strong>ub bridges the business edge limit where the rural business divisions are left out.
						</p>
					</div>
				</div>
				<div class="col-md-6">
					<div class="text sample-text-area">
							<p>
								...
								<p>
									To see half of the world business bodies using <strong style="color: #175176;">L</strong>uss<strong style="color: #9ca1a4;">H</strong>ub to ease the means of doing business, and also bringing the businesses located in the rural areas to the limelight.
							</p>
							<p>
									<span style="font-size: 20pt; line-height: 107%; font-family: 'Arial',sans-serif; color: black;">
										Problems that <strong style="color: #175176;">L</strong>uss<strong style="color: #9ca1a4;">H</strong>ub solves
									</span>
							</p>
							<p>
									Lack of stocks, lack of visibility of your product and service to the internet users, and also low accessibility of product and services.
							</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-6  col-md-6 col-sm-6">
					<div class="single-footer-widget">
						<h6>Newsletter</h6>
						<p>
							Subscribe to our mail list for important update and reviews.
						</p>
			...
			<div class="row footer-bottom d-flex justify-content-between align-items-center">
				<p class="col-lg-8 col-sm-12 footer-text m-0">
					...
					Copyright &copy;
					<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="#" target="_blank">LussHub</a>
					<!-- Link back to lusshub can't be removed. Template is licensed under CC BY 3.0. -->
				</p>
