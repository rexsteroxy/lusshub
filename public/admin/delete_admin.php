...
<div id="content">
  ...
  <a class="back-link" href="<?php echo url_for('/admin/view_admins.php'); ?>">&laquo; Back to List</a>
  ...
  <div class="admin delete">
    ...
    <form action="<?php echo url_for('/admin/delete_admin.php?id=' . h(u($admin['id']))); ?>" method="post">
      <div id="operations">
